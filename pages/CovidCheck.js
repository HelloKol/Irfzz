...
function CovidCheck({ navigation }) {
  ...
  const changePage = () =>{
    ...
    isPositve ? navigation.navigate("Positive Result") : navigation.navigate("Negative Result");
  }
  ...
  const renderQuestions = () =>
    question.map((item, index) => (
      <Questions key={index} item={item} selectedQuestion={selectedQuestion} maleOrFemale={maleOrFemale} />
    ));
